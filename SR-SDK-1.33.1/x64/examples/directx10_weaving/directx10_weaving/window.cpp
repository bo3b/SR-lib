...
Window::Window(const char* ClassName, const char* WindowTitle, DirectX::XMINT2 WindowSize)
{
    Instance = this;
...
void Window::SetPositionOnTop(size_t x, size_t y, size_t width, size_t height)
{
    ...
    SetWindowPos(WindowHandle, HWND_TOP, (int)x, (int)y, (int)width, (int)height, SWP_SHOWWINDOW);
}
