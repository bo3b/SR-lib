...
/*!
 * \brief class to be used to add Weaving to DirectX 11 based SR applications
 *
 * \ingroup API
 */
namespace SR
...
#pragma warning(suppress: 4251)
    ...
    class DIMENCOSR_API DX11Weaver : public DX11WeaverBase {
    public:
        /*!
         * \deprecated
    ...
    class DIMENCOSR_API PredictingDX11Weaver : public DX11WeaverBase {
    public:
        /*!
         * \deprecated
         * \brief Constructs a class to be used for weaving an input image of a certain size
